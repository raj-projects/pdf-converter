    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 flex items-center justify-center bg-gradient-to-r from-green-600 to-green-700 rounded-2xl mx-auto mb-6 shadow-lg">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Convert your Word documents to PDF format for professional sharing and printing with perfect layout preservation.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden max-w-4xl mx-auto">
          {!selectedFile && !downloadUrl && (
            <div className="p-8 md:p-12">
              <FileUpload
                ...
                maxSize={50}
                placeholder="Drop your Word document here or click to browse"
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-green-100 rounded-full mx-auto mb-3">
                    <i className="ri-file-lock-line text-green-600 text-xl"></i>
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-2">Universal Compatibility</h3>
                  <p className="text-sm text-gray-600">PDF files can be opened on any device or platform</p>
                </div>
                <div className="text-center p-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-blue-100 rounded-full mx-auto mb-3">
                    <i className="ri-printer-line text-blue-600 text-xl"></i>
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-2">Print Ready</h3>
                  <p className="text-sm text-gray-600">Perfect for professional printing and sharing</p>
                </div>
                <div className="text-center p-4">
                  <div className="w-12 h-12 flex items-center justify-center bg-purple-100 rounded-full mx-auto mb-3">
                    <i className="ri-layout-line text-purple-600 text-xl"></i>
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-2">Layout Preserved</h3>
                  <p className="text-sm text-gray-600">Maintains exact formatting and appearance</p>
                </div>
              </div>
            </div>
          )}
            ...
            <div className="p-8 md:p-12">
              ...
              {!isConverting && (
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white py-4 rounded-xl font-semibold text-lg hover:from-green-700 hover:to-green-800 transition-all duration-200 shadow-lg hover:shadow-xl whitespace-nowrap cursor-pointer"
                >
                  Convert to PDF
                </button>
              )}
          ...
          {downloadUrl && (
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-gray-600 mb-8">Your Word document has been successfully converted to PDF format.</p>
